...
/*   Updated: 2023/01/04 22:09:58 by rschlott         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
call philosopher & multiple_killer fct by creating threads for them */
static bool	start_simulation(t_table *table)
{
	...
	{
		if (pthread_create(&table->multiple_killer, NULL, &multiple_killer,
				table) != 0)
			return (error_failure(STR_ERR_THREAD, NULL, table));
	}
	return (true);
